...
import com.codecompass.libraryapi.model.common.LibraryApiError;
...
public class LibraryControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<LibraryApiError> handleAllException(
        ...
        return new ResponseEntity<>(new LibraryApiError(traceId,e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
