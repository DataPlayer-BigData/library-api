...
import com.codecompass.libraryapi.testutils.LibraryApiTestUtil;
import com.codecompass.libraryapi.testutils.TestConstants;
...
public class PublisherServiceTest {
    ...
    public void getPublisher_failure() throws LibraryResourceNotFoundException {
        ...
        verify(publisherRepository,times(2)).findById(123);
    }

    @Test
    public void updatePublisher_success()
            throws LibraryResourceNotFoundException, LibraryResourceAlreadyExistException {
    ...
    public void searchPublisher_success() {
        ...
        List<PublisherEntity> publisherEntityList = Arrays.asList(
                new PublisherEntity(TestConstants.TEST_PUBLISHER_NAME,TestConstants.TEST_PUBLISHER_EMALE,
                        TestConstants.TEST_PUBLISHER_PHONE),
                new PublisherEntity(TestConstants.TEST_PUBLISHER_NAME+1,TestConstants.TEST_PUBLISHER_EMALE,
                        TestConstants.TEST_PUBLISHER_PHONE)
        );
